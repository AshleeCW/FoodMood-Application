...
public class SignupActivity extends AppCompatActivity {
    ...
    private String register_url = "http://ysjcs.net/~david.benson/member/db/register.php"; // need to enter url of CS2S server  "https://ysjcs.net/~sam.holmes/member/db/register.php"
